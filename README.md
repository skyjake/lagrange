...
Lagrange is a desktop GUI client for browsing [Geminispace](https://geminiprotocol.net/). It offers modern conveniences familiar from web browsers, such as smooth scrolling, inline image viewing, multiple tabs, visual themes, Unicode fonts, bookmarks, history, and page outlines.
