...
if (the_Foundation_DIR OR
    ...
    find_package (the_Foundation 1.12.0 REQUIRED)
else ()
    ...
    if (VCPKG_TOOLCHAIN)
        # Re-find the mandatory dependencies; we don't have visibility to
        # the_Foundation's CMake variables.
...
if (ENABLE_HARFBUZZ AND VCPKG_TOOLCHAIN)
    find_package (harfbuzz CONFIG REQUIRED)
    set (HARFBUZZ_FOUND YES)
elseif (ENABLE_HARFBUZZ)
...
if (ENABLE_FRIBIDI AND VCPKG_TOOLCHAIN)
    set (FRIBIDI_DIR "" CACHE PATH "Location of fribidi")
    if (FRIBIDI_DIR STREQUAL "")
        # CMAKE_PREFIX_PATH already includes the vcpkg installed tree.
        find_file (FRIBIDI_H fribidi/fribidi.h)
        if (NOT FRIBIDI_H)
            message (FATAL_ERROR "Not found: fribidi.h from fribidi (set FRIBIDI_DIR)")
        endif ()
        get_filename_component (FRIBIDI_DIR ${FRIBIDI_H} PATH)
        get_filename_component (FRIBIDI_DIR ${FRIBIDI_DIR} PATH)
        get_filename_component (FRIBIDI_DIR ${FRIBIDI_DIR} PATH)
    endif ()
    set (FRIBIDI_INCLUDE_DIRS ${FRIBIDI_DIR}/include/fribidi)
    set (FRIBIDI_LDFLAGS ${FRIBIDI_DIR}/lib/fribidi.lib)
    set (FRIBIDI_FOUND YES)
elseif (ENABLE_FRIBIDI)
